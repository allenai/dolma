...
def parse_args() -> argparse.Namespace:
    ...
    if opts.use_wandb:
        assert opts.wandb_project is not None, "--wandb-project is required when --use-wandb is set"
        assert opts.wandb_entity is not None, "--wandb-entity is required when --use-wandb is set"
