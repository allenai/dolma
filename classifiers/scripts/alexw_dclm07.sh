...
GLOBAL_IDX='*'
LOCAL_IDX='*'
DOCUMENTS="s3://ai2-llm/pretraining-data/sources/dclm/baseline/documents/*/*/*zstd"
MODEL_NAME="data-delve/gte-base-en-v1.5_topic-v3.8_url1"
BATCH_SIZE=70
PRIORITY="high"
CLUSTER="ai2/jupiter*" #"ai2/augusta-google-*" # # "ai2/s2-*" 


# Generate run hash
RUN_HASH=$(echo -n "${MODEL_NAME}${DOCUMENTS}" | md5sum | awk '{print $1}')
RUN_NAME="BASELINE_topic_datadelve_classifier_davidg_${RUN_HASH:0:8}"
