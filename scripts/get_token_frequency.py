...
class CountTokensProcessor(BaseParallelProcessor):
    @classmethod
    def increment_progressbar(
        ...
        return super().increment_progressbar(queue, files=files, tokens=tokens)
    ...
    def process_single(
        ...
        **kwargs: Any,
        ...
        """
        This method is called for each npy file. Counts the occurences of each token type in the file. It outputs this information to a json file.
        """
...
def main():
    ...
    with TemporaryDirectory(dir=args.temp_dir) as tmpdir:
        ...
        processor = CountTokensProcessor(
